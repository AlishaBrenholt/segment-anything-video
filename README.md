...
To use this you need to copy and paste in the file that the loss is happening after the data was generated. The code
will expect a video to be generated and will read it from the file. You can change the path by changing the pred_y value
to the path of the video. There is a temporary task_loss value that you can replace with the actual task loss.
We also added what we think the total_task_loss would look like.
